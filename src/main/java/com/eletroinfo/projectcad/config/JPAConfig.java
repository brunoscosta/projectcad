...
@Configuration
@EnableJpaRepositories(basePackageClasses = Projetos.class, enableDefaultTransactions = false)
...
public class JPAConfig {
	...
	public DataSource dataSource() {
		...
		return dataSourceLookup.getDataSource("jdbc/projectcadDB");
	}
	...
	public EntityManagerFactory entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
		...
		factory.setPackagesToScan(Projeto.class.getPackage().getName());
